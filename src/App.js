...
import { CreateHasilLab } from './screens/CreateHasilLab';
				...
				<div className="App">
					<nav className="navbar navbar-expand-sm navbar-dark bg-dark">
						...
						<div className="collapse navbar-collapse">
							<ul className="navbar-nav mr-auto">
								...
								<li className='nav-item'>
									<NavLink to="/all-farmasi" exact className="nav-link" activeClassName="active">Daftar Staff Farmasi</NavLink>
								</li>
							</ul>
						</div>
					</nav>
					...
					<div className="container">
						<Switch>
							...
							<Route path="/tambah-lab/:id" exact component={CreateHasilLab} />
